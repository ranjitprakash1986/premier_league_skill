...
We have several simulated posterior samples for each team. We cannot use the entire 900 simulations directly to plot our 50% credible intervals. Hence, grouping by team with the 900 samples to obtain the necessary intervals for each team.
